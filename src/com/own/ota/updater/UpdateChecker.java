...
import com.own.center.OwnOTACenter;
...
public class UpdateChecker extends AsyncTask<Context, Integer, String> {
        ...
        try {
            ...
            while ((strLine = br.readLine()) != null) {
                ...
                if (line[0].equalsIgnoreCase("ro.product.device")) {
                    ...
                    CurVer = line[1].trim();
                } else if (strDevice == null && line[0].equalsIgnoreCase("ro.ownrom.device")){
                    strDevice = line[1].trim();
                }
            }
            br.close();
    ...
    protected String doInBackground(Context... arg) {
        mContext = arg[0];
        Message msg;
        if (mContext != null && mContext.toString().contains("OwnOTACenter")) {
    ...
    private void showNotification() {
        ...
        Intent intent = new Intent(mContext, OwnOTACenter.class);
